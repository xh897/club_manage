      ...
      <div v-show="table" class="table">
        ...
        >
          ...
          <el-table-column
            ...
            width="200px" >
            <template slot-scope="scope">
              <el-button size="mini" type="primary" @click="goEdit(scope.row)">编辑
              </el-button>
              <el-button
                size="mini"
                type="danger"
  ...
  methods: {
    ...
    async handleConfirm(type) {
      ...
      if (this.model.organization_name === "") {
        return this.$message.info("请选择社团名称");
      }
      if (this.model.icon === "") {
      ...
      if (this.model.user_id === "") {
        return this.$message.info("请选择社团管理员");
      }
      if (type === 1) {
