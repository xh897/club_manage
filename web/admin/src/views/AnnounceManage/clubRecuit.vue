      ...
      <el-card style="margin: 10px">
        <div v-show="table" class="table">
          ...
          <el-table
            ...
            <el-table-column label="社团招新主题" prop="title" align="center" />
            ...
            <el-table-column
              ...
              width="200px">
              <template slot-scope="scope">
                <el-button size="mini" type="primary" @click="goEdit(scope.row)">详情
                </el-button>
                <el-button
                  size="mini"
                  type="danger"
        ...
        <el-form v-show="!table" label-width="130px">
          ...
          <el-form-item label="社团招新主题">
            <el-input
              v-model="model.title"
              placeholder="请输入社团招新主题"
              size="mini"
            />
          </el-form-item>
          <el-form-item label="社团招新举办方">
            <el-input
              v-model="model.host"
              placeholder="请输入社团招新举办方"
              size="mini"
            />
          </el-form-item>
          <el-form-item label="社团招新时间">
            <el-date-picker
              v-model="value1"
              type="datetimerange"
              range-separator="至"
              start-placeholder="社团招新开始日期"
              end-placeholder="社团招新结束日期"
              value-format="yyyy-MM-dd HH:mm:ss"
            >
            </el-date-picker>
          </el-form-item>
  
          <el-form-item label="社团招新地点">
            <el-input
              v-model="model.activityPlace"
              placeholder="请输入社团招新地点"
              size="mini"
            />
          </el-form-item>
  
          <el-form-item label="招新对象">
            <el-input
  ...
  export default {
    ...
    methods: {
      ...
      async handleConfirm(type) {
        ...
        console.error(this.value1, 3434);
        this.model.timeStart = this.value1[0].slice(0, 10);
        this.model.timeEnd = this.value1[1].slice(0, 10);
        if (type === 1) {
